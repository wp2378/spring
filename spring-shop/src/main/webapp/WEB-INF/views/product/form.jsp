...
<div class="container">
	<div class="row mb-3">
		<div class="col-12">
			...
			<form class="border bg-lighit p-3" method="post" action="create" enctype="multipart/form-data">
				<div class="form-group mb-3">
					<label class="form-label">제조회사</label>
					<select class="form-control" name="companyNo">
				...
				<div class="form-group mb-3">
					<label class="form-label">입고사진</label>
