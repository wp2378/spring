...
public class AdminController {
	 ...
	 * 		없음
	 * 요청 내용
	 * 		요청URL에 포함된 사용자 아이디에 해당하는 사용자정보를 요청한다.
	 * 처리 내용
	 * 		요청URL에 포함된 사용자 아이디를 @PathVaraible 어노테이션을 이용해서 요청핸들러 메소드의 매개변수에 바인딩시키고,
	 * 		해당 아이디로 사용자를 조회한 다음 UserDto객체를 생성해서 옮겨 담고, 직렬화시켜 응답으로 보낸다.
	 */
