...
public class HomeController {
	...
	public Company app3() {
		...
		c.setNo(100);
		c.setName("삼성전자");
		c.setTel("02-7777-7777");
		c.setZipcode("12345");
		c.setAddress1("서울특별시 종로구");
		c.setAddress2("봉익동 디아망빌딩 4층");
	...
	public String registerUser(@Valid UserRegisterForm form, BindingResult errors, RedirectAttributes redirectAttributes) {
